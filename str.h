...
_STR_H_EXTERN_ str_t *str_dup(const str_t *const);
_STR_H_EXTERN_ str_t *str(const char *const);
_STR_H_EXTERN_ void str_free(str_t *);
_STR_H_EXTERN_ char str_get(const str_t *const, const unsigned long);
_STR_H_EXTERN_ void str_chadd(str_t *, const char);
